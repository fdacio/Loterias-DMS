 ...
 */
public class ArquivoResultadoUrlLotofacilDAO extends UrlDAO {

    private Context context;

    public ArquivoResultadoUrlLotofacilDAO(Context context) {
    ...
    public void save(String url) {
        ...
        editor.putString(Constantes.URL_ARQUIVO_RESULTADOS_LOTOFACIL, url);
        editor.commit();
