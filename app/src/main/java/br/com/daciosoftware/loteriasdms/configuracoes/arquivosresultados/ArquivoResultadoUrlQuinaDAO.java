 ...
 */
public class ArquivoResultadoUrlQuinaDAO extends UrlDAO {

    private Context context;

    public ArquivoResultadoUrlQuinaDAO(Context context) {
    ...
    public void save(String url) {
        ...
        editor.putString(Constantes.URL_ARQUIVO_RESULTADOS_QUINA, url);
        editor.commit();
